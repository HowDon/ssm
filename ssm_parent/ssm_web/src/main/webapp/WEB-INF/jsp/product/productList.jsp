...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<form id="deleteForm" action="${pageContext.request.contextPath}/product/deleteProductByIds" method="post">
					<!-- 数据表格 -->
					<div class="table-box">
							...
							<div class="form-group form-inline">
								<div class="btn-group">
									<button type="button" class="btn btn-default" title="新建"
										onclick='location.href="${pageContext.request.contextPath}/product/addProductUI"'>
										<i class="fa fa-file-o"></i> 新建
									</button>
									<button type="button" class="btn btn-default" title="删除"
										onclick='javaScript:deleteByIds();'>
								...
								<tr>
									...
									<td class="text-center">
										<button type="button" class="btn bg-olive btn-xs"
											onclick='location.href="${pageContext.request.contextPath}/product/updateProductUI?id=${product.id}"'>修改</button>
										<button type="button" class="btn bg-olive btn-xs"
											onclick='javaScript:deleteById(${product.id})'>删除</button>
									</td>
								</tr>
                                </c:forEach>
                            </tbody>
	...
	<script>
		...
		function  deleteById (productId) {
			...
			if(flag){
			    //请求删除的url路径
				window.location.href="${pageContext.request.contextPath}/product/deleteProduct?productId="+productId;
			}
        }
        function  deleteByIds() {
			//获取form表单 提交请求删除的方法
			//$("#deleteForm").submit()
			var flag = window.confirm("确定删除所有吗？");
			if (flag){
